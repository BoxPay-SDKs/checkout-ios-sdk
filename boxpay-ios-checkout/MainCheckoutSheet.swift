...
//    @State private var isSuccessScreenVisible = true
...
//    @State private var isUPIValid: Bool? = nil
...
//        if let options = configurationOptions {
//            if options[ConfigurationOption.enableSandboxEnv] == true {
//                apiManager.setBaseURL(baseUrlTest)
//            } else {
//                apiManager.setBaseURL(baseUrlProd)
//            }
//            if options[ConfigurationOption.showBoxpaySuccessScreen] == true {
//                self.isSuccessScreenVisible = options[ConfigurationOption.showBoxpaySuccessScreen] ?? true
//            }
//        } else {
//            apiManager.setBaseURL(baseUrlProd)
//        }
...
//                                    moveToWalletPaymentScreen: $moveToWalletPaymentScreen,
//                                    moveToBNPLScreen: $moveToBNPLScreen,
//                                    moveToNetBankingScreen: $moveToNetBankingScreen,
//                                    moveToEMIOptionsScreen: $moveToEMIOptionsScreen,
//                                    upiIntentMethod: upiIntentMethod,
//                                    upiCollectMethod: upiCollectMethod
//                                )
//                            }
...
//                        }
//                        
//                    }.background(Color(hex: "#F5F6FB").ignoresSafeArea()).preferredColorScheme(.light)
...
//                            timerManager.startTimer(duration: <#T##TimeInterval#>)
...
//                    }
//                    .onReceive(timerManager.$hasExpired) { expired in
//                            if expired {
//                                showSessionExpireScreen = true
//                            }
//                        }
...
//                                transactionID: paymentViewModel.transactionId,
//                                reasonCode: paymentViewModel.reasonCode,
//                                reason: paymentViewModel.statusReason,
//                                onRetryPayment: {
...
//                            .rotationEffect(.degrees(orderDetailsVisibility ? 0 : 180))
//                            .animation(.easeInOut, value: orderDetailsVisibility)
//                    }
...
//                Text("\(totalAmountValue) via \(selectedUPIApp)")
//                    .font(.custom("Poppins-SemiBold", size: 16))
//            )
...
//                    .foregroundColor(Color(hex:viewModel.sessionData?.merchantDetails.checkoutTheme.primaryButtonColor ?? "#000000"))
//                    
//                
//                Text("Add new UPI Id")
//                    .font(.custom("Poppins-SemiBold", size: 14))
...
//                Image(frameworkAsset: "chevron")
//                    .frame(width: 10, height: 10)
//                    .rotationEffect(.degrees(upiCollectExpanded ? 0 : 180))
//                    .animation(.easeInOut, value: upiCollectExpanded)
//            }
//            .onTapGesture {
//                toggleUPICollect()
//            }
//            .padding(16)
//            .background(
//                Image(frameworkAsset: upiCollectExpanded ? "add_upi_id_background" : "")
//                    .resizable()
//                    .padding(.bottom,-14)
//            )
//            
...
//                    onPay: handleUPIPay,
//                    saveOptionVisible: isSaveOptionVisible
//                )
//            }
//        }
//    }
...
//        // Check if @ exists and get distance from @ to end
//        guard let atIndex = upiID.firstIndex(of: "@") else {
//            return nil // No @ present yet
//        }
//
//        let domainPartLength = upiID.distance(from: atIndex, to: upiID.endIndex) - 1 // Exclude @ itself
//
//        // Not enough characters after @ yet
//        if domainPartLength < 2 {
//            return nil
//        }
//
//        // Validate full UPI format using regex
//        let regex = try! NSRegularExpression(pattern: "^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]{3,}$")
...
//                                    onChange?(newText) // 👈 trigger external callback
//                                }
//                .accentColor(Color(hex: "#2D2B32"))
//
//        }
//    }
//}
...
//                    .font(.custom("Poppins-SemiBold", size: 16))
//            )
//                .foregroundColor(isUPIValid == true ? Color.white : Color(hex: "#ADACB0"))
//                .frame(maxWidth: .infinity)
//                .padding(11)
//                .background(isUPIValid == true ? Color.green : Color(hex: "#E6E6E6"))
//                .cornerRadius(8)
//        }
//        .padding(.top, 2)
//        .padding(.bottom, 16)
...
//        
//        if cardsMethod {
//            options.append(PaymentOption(imageName: "ic_card", title: "Cards", subTitle: "Save and pay via cards"))
//        }
//        if walletMethods {
//            options.append(PaymentOption(imageName: "ic_wallet", title: "Wallet", subTitle: "Paytm, GooglePay, PhonePe & more"))
//        }
//        if netBankingMethods {
//            options.append(PaymentOption(imageName: "ic_netBanking", title: "Netbanking", subTitle: "Select from a list of banks"))
//        }
//        if emiMethod {
//            options.append(PaymentOption(imageName: "ic_emi", title: "EMI", subTitle: "Easy Installments"))
//        }
//        if bnplMethod {
//            options.append(PaymentOption(imageName: "ic_bnpl", title: "Buy Now Pay Later", subTitle: "Save and pay via cards"))
//        }
//        
//        return options
//    }
...
//                                .stroke(Color(hex: "#DCDEE3"), lineWidth: 1)
//                        )
//                } placeholder: {
//                    Rectangle()
...
//            }
//
//            // VStack for item name & quantity + amount at the top right
...
//                    Text(item.amountWithoutTaxLocaleFull)
//                        .font(.custom("Poppins-Regular", size: 12))
//                )
//                .foregroundColor(Color(hex: "#2D2B32"))
...
//                    
//                    // ✅ Show only if values exist
//                    if let subTotal = subTotal { infoRow(label: "Subtotal", value: subTotal) }
//                    if let tax = tax { infoRow(label: "Tax", value: tax) }
//                    if let discount = discount { infoRow(label: "Discount", value: discount, textColor: Color.green) }
//                    if let shipping = shipping { infoRow(label: "Delivery Charge", value: shipping) }
//                    
